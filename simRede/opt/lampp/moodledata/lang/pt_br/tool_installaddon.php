...
$string['installfromziptype_help'] = 'Para os plugins que declaram corretamente o nome do seu componente, o instalador pode detectar o tipo de plugin automaticamente. Se a auto-detecção falhar, escolha o tipo correto de plug-in manualmente. Aviso: O procedimento de instalação pode falhar se um tipo de plugin incorreto for definido.';
