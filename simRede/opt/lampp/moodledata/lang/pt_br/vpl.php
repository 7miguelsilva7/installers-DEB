...
/**
 * Strings for component 'vpl', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   vpl
...
$string['changesNotSaved'] = 'Alterações não foram salvas';
...
$string['delete_file_fq'] = 'exlcuir arquivo \'{$a}\'?';
$string['delete_file_q'] = 'Exlcuir arquivo?';
$string['description'] = 'Descrição';
$string['diff'] = 'diff';
$string['discard_submission_period'] = 'Período de descarte de envios';
...
$string['filesChangedNotSaved'] = 'Arquivos foram alterado mas não foram salvos';
$string['filesNotChanged'] = 'Arquivos não foram alterados';
$string['filestoscan'] = 'Arquivos a serem examinados';
$string['fileupdated'] = 'O arquivo \'{$a}\' foi alterado';
$string['find'] = 'Buscar';
...
$string['gradeoptions'] = 'Opções de notas';
...
$string['maxresourcelimits'] = 'Limite de recursos de execução';
...
$string['outofmemory'] = 'Falta de memória';
$string['paste'] = 'Colar';
...
$string['vpl_debug.sh'] = 'Este roteiro prepara a depuração';
$string['vpl_evaluate.cases'] = 'Casos para teste de execução';
$string['vpl_evaluate.sh'] = 'Este roteiro prepara a avaliação';
$string['vpl:grade'] = 'Atribuir nota a tarefas VPL';
$string['vpl:manage'] = 'Gerenciar tarefas VPL';
$string['vpl_run.sh'] = 'Este roteiro prepara a execução';
