...
$string['keys'] = 'Chaves';
$string['listreservedwords'] = 'Lista de palavras reservadas<br/>(utilizada para manter <a href="http://docs.moodle.org/en/XMLDB_reserved_words" target="_blank">XMLDB_reserved_words</a> atualizado)';
...
$string['nomissingindexesfound'] = 'Nenhum índice foi perdido, seu banco de dados não precisa de outras ações.';
