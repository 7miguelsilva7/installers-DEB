...
$string['requiresubnet_help'] = 'A gravação de presença pode ser restrita a sub-redes específicas, se definida  uma lista separada por vírgulas de endereços IP parciais ou completos.';
