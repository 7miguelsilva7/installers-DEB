...
$string['forcenewattempt_help'] = 'Esta configuração oculta a caixa de seleção "Iniciar nova tentativa" e evita o modo de revisão.

O SCORM permite que um estudante volte para a mesma tentativa em qualquer ponto e uma nova tentativa não é possível, a menos que a tentativa anterior tenha sido definida como "concluída", "passada" ou "falhada". Se o pacote SCORM não fizer isso, o estudante sempre voltará a entrar na mesma tentativa.';
