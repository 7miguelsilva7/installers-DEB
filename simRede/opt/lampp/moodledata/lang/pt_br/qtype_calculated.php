...
$string['synchronize'] = 'Sincronizar os dados de conjuntos compartilhados com outras questões do questionário.';
$string['synchronizeno'] = 'Não sincronizar';
$string['synchronizeyes'] = 'Sincronizar';
$string['synchronizeyesdisplay'] = 'Sincronizar e mostrar o nome dos conjuntos de dados compartilhados como prefixo do nome da questão';
