...
Os estudantes podem enviar qualquer conteúdo digital (arquivos), como documentos de testo ou planilhas e também podem digitar um texto diretamente em um campo utilizando o editor de texto.

Os envios são avaliadas por um formulário de avaliação multi-critérios definido pelo professor. O processo de avaliação por pares e a compreensão do formulário de avaliação podem ser praticados antecipadamente com exemplos de envios fornecidos pelo professor, juntamente com uma avaliação de referência. Os estudantes recebem a oportunidade de avaliar uma ou mais dos envios de seus colegas. Envios e revisores podem ser anônimos, se necessário.
...
$string['submissionsreport'] = 'Relatório de envios do laboratório de avliação';
