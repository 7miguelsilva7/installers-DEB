...
/**
 * Strings for component 'repository_boxnet', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['pluginname_help'] = 'Repositório no Box';
$string['saved'] = 'Dados do Boxforam salvos';
