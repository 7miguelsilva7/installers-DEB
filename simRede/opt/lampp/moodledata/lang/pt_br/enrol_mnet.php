...
/**
 * Strings for component 'enrol_mnet', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   enrol_mnet
...
$string['mnet_enrol_description'] = 'Publique este serviço para permitir que administradores de {$a} inscrevam estudantes em cursos que você criou no seu servidor.<br/><ul><li><em>Dependência</em>: Você deve também <strong>publicar</strong> o serviço SSO (Provedor de Identidade) para {$a}.</li><li><em>Dependência</em>: Você deve também <strong>subscrever</strong> no serviço SSO (Provedor de Serviço) em {$a}.</li></ul><br/>Subscrever este serviço para ser capaz de inscrever seus alunos em cursos em {$a}.<br/><ul><li><em>Dependência</em>: Você deve também <strong>subscrever</strong> o serviço SSO (Provedor de Identidade) em {$a}.</li><li><em>Dependência</em>: Você deve também <strong>publicar</strong> o serviço SSO (Provedor de Serviço) em {$a}.</li></ul><br/>';
