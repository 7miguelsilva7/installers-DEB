...
/**
 * Strings for component 'quiz_statistics', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['calculatingallstats'] = 'Calculando estatísticas para o questionário, questões e analisando dados das respostas';
...
$string['negcovar_help'] = 'A nota desta questão para esse conjunto de tentativas no questionário varia de maneira oposta ao da nota de todas as tentativas. Isso significa qual a nota de todas as tentativas tende a estar abaixo da média quando a nota para esta questão está acima da média e vice-versa.

Nossa equação de peso efetivo da questão não pode ser calculado neste caso. Os cálculos de peso efetivo da questão para as outras questões neste questionário são o peso efetivo de questão para estas questões se as questões em destaque com uma covariância negativa é dada para uma avaliação máxima de zero.

Se você editar um questionário e atribuir a esta(s) questão(ões) com covariância negativa um máximo grau de zero, então o peso efetivo para estas questões será zero e o peso efetivo da questão das outras questões serão calculados agora.';
...
$string['questionstatistics'] = 'Estatísticas das questões';
...
$string['statistics:componentname'] = 'Relatório de estatísticas do questionário';
$string['statisticsreport'] = 'Relatório de estatísticas';
$string['statisticsreportgraph'] = 'Estatística das posições da questão';
