...
$string['invaliddatarootpermissions'] = 'Permissões inválidas detectadas ao tentar criar um diretório em $CFG->dataroot. O administrador deve corrigir estas permissões.';
...
$string['mssqlrcsmodemissing'] = 'O banco de dados não está utilizando o modo esperado de READ_COMMITTED_SNAPSHOT. Isso pode levar a resultados errados, especialmente em cenários de alta concorrência. Por favor, ative-o para o funcionamento correto. Para mais informações, consulte a documentação <a href="https://docs.moodle.org/en/Installing_MSSQL_for_PHP"> Instalando MSSQL para PHP </a>.';
...
$string['oauth1accesstoken'] = 'Erro OAuth 1.0: Não obtivemos o token de acesso.';
$string['oauth1requesttoken'] = 'Erro OAuth 1.0: Não obtivemos o token da solicitação - o provedor de serviços pode estar temporariamente indisponível.';
...
$string['sessionerroruser2'] = 'Foi detectado um erro no servidor relativo ao seu login. Faça o login novamente ou reinicie seu navegador.';
...
$string['storedfilecannotreadfile'] = 'Não é possível ler o arquivo \'{$a}\'. O arquivo não existe ou há um problema de permissão.';
