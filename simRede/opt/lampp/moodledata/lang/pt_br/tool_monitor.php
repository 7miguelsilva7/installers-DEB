...
/**
 * Strings for component 'tool_monitor', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['messagetemplate_help'] = 'Este é o conteúdo da mensagem que será enviada aos usuários quando estiverem reunidas as condições dadas da regra. Você está autorizado a usar seguintes modelos neste.<br/><br/>

* {link} - Link para o local onde o evento aconteceu
* {modulelink} - Link para o módulo onde o evento aconteceu
* {rulename} - Nome desta regra
* {description} - Descrição da regra
* {eventname} - Nome do evento associado à regra';
