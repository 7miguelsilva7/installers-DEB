...
$string['competencyscale'] = 'Escala de competência: {$a}';
$string['competencyscaledescription'] = 'Escala de competências criada por importação';
$string['confirm'] = 'Confirmar';
$string['confirmcolumnmappings'] = 'Confirmar os mapeamentos de colunas';
$string['csvdelimiter'] = 'Delimitador CSV';
$string['description'] = 'Descrição';
$string['descriptionformat'] = 'Formato da descrição';
$string['encoding'] = 'Codificação';
$string['export'] = 'Exportar';
$string['exportid'] = 'Identificador exportado (opcional)';
$string['exportnavlink'] = 'Exportar estrutura de competência';
$string['idnumber'] = 'Número identificador';
$string['import'] = 'Importar';
$string['importfile'] = 'Arquivo CSV de descrição da estrutura';
$string['importfile_help'] = 'Uma estrutura de competências pode ser importada através de um arquivo texto. O formato do arquivo pode ser determinado através da criação de uma nova estrutura de competências no site e, em seguida, exportá-lo.';
$string['importingfile'] = 'Importando dados do arquivo';
...
$string['parentidnumber'] = 'Número identificador do antecessor';
$string['pluginname'] = 'Importar estrutura de competência';
$string['processingfile'] = 'Processando arquivo';
$string['relatedidnumbers'] = 'Números identificadores de competência com referência cruzada';
