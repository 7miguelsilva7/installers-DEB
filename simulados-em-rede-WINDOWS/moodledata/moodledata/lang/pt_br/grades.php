...
$string['showcalculations_help'] = 'Se habilitado, ao editar, um ícone de calculadora é mostrado para cada item e categoria de nota com um indicador visual de que o item de nota é calculado.';
$string['showcontributiontocoursetotal'] = 'Mostrar contribuição para o total do curso';
$string['showcontributiontocoursetotal_help'] = 'Se deve ser mostrada uma coluna de porcentagens indicando quanto cada item de nota contribui para o percentual total do curso do usuário (após a aplicação da ponderação).';
