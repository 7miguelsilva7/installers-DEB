...
/**
 * Strings for component 'portfolio_boxnet', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['foldercreatefailed'] = 'Falha ao criar seu diretório no Box';
$string['folderlistfailed'] = 'Falha ao trazer uma lista a partir do Box';
...
$string['noticket'] = 'Não foi possível retornar um ticket do Box para iniciar a sessão de autenticação';
$string['password'] = 'Sua senha Box (não será armazenada)';
$string['pluginname'] = 'Repositório Box';
$string['sendfailed'] = 'Falha ao enviar conteúdo para Box:{$a}';
