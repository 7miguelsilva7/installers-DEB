...
$string['configallowemailaddresses'] = 'Para restringir todos os novos endereços de e-mail a domínios específicos, inclua a lista deles aqui, separados por espaços. Todos os outros domínios serão recusados. Para permitir subdomínios, inclua o domínio precedido por um ponto. Para permitir um domínio raiz junto com seus subdomínios, adicione-o domínio duas vezes - uma vez precedido por um ponto e outra vez sem.Por exemplo <strong>.faculdade.edu.br faculdade.edu.br.</strong>';
...
$string['configcustomusermenuitems'] = 'Você pode configurar o conteúdo do menu do usuário (com exceção do link logout, que é adicionado automaticamente). Cada linha é separada por caracteres de pipe e consiste em 1) uma string no formato "langstringname, componentname" ou como texto simples, 2) uma URL, e 3) um ícone ou como um ícone pix ou como um URL. Os divisores # podem ser usados adicionando uma linha de um ou mais caracteres quando desejado.';
...
$string['configdeleteunconfirmed'] = 'Para alguns métodos de autenticação, como o auto-registro baseado em email, os usuários devem confirmar sua conta dentro de um determinado período de tempo. Após esse período, todas as contas antigas não confirmadas são excluídas.';
...
$string['onlynoreply'] = 'Somente a partir de um endereço de email sem resposta.';
