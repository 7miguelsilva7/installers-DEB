...
$string['config_importrecordings_description'] = 'Essas configurações são características específicas';
$string['config_importrecordings_enabled'] = 'Importar gravações ativado';
...
$string['config_preuploadpresentation'] = 'Configuração para o recurso de "Pré-envio de apresentação"';
...
$string['config_preuploadpresentation_enabled'] = 'Pré-envio de apresentação habilitado';
...
$string['config_recording_icons_enabled_description'] = 'Quando ativado, o painel de gerenciamento de gravação mostra ícones para publicar / não publicar e excluir ações.';
$string['config_recordingready_enabled'] = 'Notificações quando gravação estiver pronta habilitado';
...
$string['config_sendnotifications_enabled_description'] = 'O recurso Enviar notificação está ativado na interface do usuário quando a sala ou conferência é adicionada ou atualizada.';
...
$string['mod_form_block_presentation'] = 'Conteúdo de apresentação';
...
$string['mod_form_field_conference_name'] = 'Nome de Conferência';
...
$string['mod_form_field_instanceprofiles_help'] = 'Selecionar o tipo para essa instância de BigBlueButtonBN';
...
$string['mod_form_field_notification_created_help'] = 'Envie uma notificação aos usuários inscritos para informá-los de que essa atividade foi criada';
$string['mod_form_field_notification_help'] = 'Envie uma notificação aos usuários inscritos para informá-los de que essa atividade foi criada ou modificada';
$string['mod_form_field_notification_modified_help'] = 'Envie uma notificação aos usuários inscritos para informá-los de que esta atividade foi modificada';
...
$string['mod_form_field_wait_help'] = 'Os espectadores devem aguardar até um moderador entrar na sessão antes de poder fazer isso';
$string['mod_form_field_welcome'] = 'Mensagem de boas vindas';
$string['mod_form_field_welcome_help'] = 'Substitui a mensagem padrão configurada para o servidor BigBlueButton. A mensagem pode incluir palavras-chave (%%CONFNAME%%, %%DIALNUM%%, %%CONFNUM%%) que serão substituídas automaticamente e também tags html como <b>...</b> or <i></i>';
$string['modulename'] = 'BigBlueButtonBN';
$string['modulename_help'] = 'BigBlueButtonBN permite que você crie a partir de links do Moodle salas de aula em tempo real usando BigBlueButton, um sistema de conferência web de código aberto para educação a distância.

Usando BigBlueButtonBN você pode especificar para o título, descrição, entrada de calendário (que dá um intervalo de datas para ingressar na sessão), grupos e detalhes sobre a gravação da sessão on-line.

Para ver as gravações mais tarde, adicione o recurso RecordingsBN a este curso.';
...
$string['view_conference_action_end'] = 'Finalizar sessão';
...
$string['view_message_conference_wait_for_moderator'] = 'Esperando um moderador para se juntar.';
$string['view_message_finished'] = 'Esta atividade acabou.';
$string['view_message_has_joined'] = 'se juntou';
$string['view_message_have_joined'] = 'se juntou';
...
$string['view_message_recordings_disabled'] = 'As gravações foram desativadas neste servidor. As instâncias BigBlueButtonBN para gravações apenas não podem ser usadas.';
...
$string['view_message_session_has_user'] = 'Há sim';
$string['view_message_session_has_users'] = 'tem';
$string['view_message_session_no_users'] = 'Não há usuários nesta sessão';
...
$string['view_recording_button_return'] = 'Retorne';
$string['view_recording_course'] = 'Curso';
$string['view_recording_date'] = 'Data';
$string['view_recording_delete_confirmation'] = 'Tem certeza de excluir este {$a}?';
...
$string['view_recording_list_actionbar_protect'] = 'Torná-lo privado';
...
$string['view_recording_list_actionbar_unpublish'] = 'Não publicar';
$string['view_recording_list_action_edit'] = 'Atualizando';
$string['view_recording_list_action_play'] = 'Toque';
