...
$string['autoupdate_settings_desc'] = '<p>Selecione os campos para atualizar quando o script de sincronização estiver rodando (enrol/ldap/cli/sync.php).</p><p>Quando pelo menos um campo for selecionado a atualização acontecerá.</p>';
