...
$string['templatecourse_desc'] = 'Opcional: cursos criados automaticamente podem copiar as configurações de um curso modelo. Digite aqui o nome abreviado do curso modelo.';
