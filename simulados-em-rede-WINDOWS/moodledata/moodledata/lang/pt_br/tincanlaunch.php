...
/**
 * Strings for component 'tincanlaunch', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['eventactivitycompleted'] = 'Atividade concluída';
$string['lrsheading'] = 'Configuração LRS';
