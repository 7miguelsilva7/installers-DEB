...
$string['addselectedquestionstoquiz'] = 'Adicionar as questões selecionadas ao questionário';
...
$string['autosaveperiod_desc'] = 'As respostas podem ser salvas automaticamente durante as tentativas. As respostas são salvas sempre que uma for alterada, e depois após esse intervalo. Existe uma relação: um intervalo mais curto aumenta a carga do servidor, mas reduz a chance dos estudantes perderem seu trabalho. Se você deseja definir este intervalo muito curto, altere o valor gradativamente e monitore a carga do servidor. Se a carga ficar muito alta, utilize um intervalo mais longo novamente. Definir o intervalo como 0 desliga o salvamento automático.';
...
* O questionário só vai começar se o estudante tem um JavaScript habilitado no navegador.
...
$string['cannoteditafterattempts'] = 'Você não pode adicionar ou remover questões, pois já foram registradas tentativas neste questionário. ({$a})';
$string['cannotfindprevattempt'] = 'Não foi possível encontrar tentativa anterior.';
...
$string['confignewpageevery'] = 'Ao adicionar questões no questionário, as quebras de página serão inseridas automaticamente conforme a configuração escolhida aqui.';
...
$string['configtimelimit'] = 'Limite de tempo padrão para questionários em minutos. 0 significa sem limite de tempo.';
...
$string['decimalplaces_help'] = 'Esta configuração define o número de dígitos após o ponto decimal ao mostrar as notas. Isso afeta apenas a visualização de notas, não as notas armazenadas no banco de dados, nem os cálculos internos, que são realizados com total precisão.';
...
$string['delay1st2nd_help'] = '<p>Se você configurar um intervalo, um estudante tem que esperar este período após a primeira tentativa, antes que possa fazer a segunda tentativa.</p>';
$string['delay2'] = 'Intervalo entre a segunda e outras tentativas';
$string['delaylater'] = 'Força demora entre tentativas posteriores.';
$string['delaylater_help'] = '<p>Se você configurar um intervalo aqui, então um estudante tem que esperar este período antes que possa fazer outras tentativas.</p>';
...
Você iniciou uma tentativa no questionário \'{$a->quizname}\' no curso \'{$a->coursename}\' mas não finalizou a tentativa.
...
$string['filloutnumericalanswer'] = 'Você precisa digitar uma resposta possível e permitida dentro da tolerância. A primeira resposta encontrada será utilizado para determinar a nota e a avaliação. Se você colocar um retorno sem resposta no final, ele será usado para os estudantes cujas respostas não estejam na lista.';
...
$string['gradetopassnotset'] = 'Não foi definida uma nota de aprovação para este questionário, portanto esta opção não pode ser utilizada. Como alternativa, utilize a opção exigir nota.';
...
$string['invalidquestionid'] = 'Identificador da questão inválido';
...
$string['noquestionsnotinuse'] = 'Esta questão aleatória não está em uso, pois sua categoria está vazia.';
...
$string['questiondeleted'] = 'Esta questão foi deletada.';
...
$string['questioninuse'] = 'A questão \'{$a->questionname}\' é atualmente usada em:<br />{$a->quiznames}<br />Ela não será excluída destes questionários mas apenas das categorias.';
$string['questionmissing'] = 'Faltando questão para esta sessão';
...
$string['quizwillopen'] = 'Este questionário irá abrir {$a}';
...
$string['settingsoverrides'] = 'Configurações de Sobreposição';
...
$string['shufflewithin_help'] = 'Se habilitada, as partes que compõem cada questão serão embaralhadas aleatoriamente toda vez que um estudante iniciar uma tentativa do questionário, desde que esta opção esteja também habilitada na configuração das questões. Esta configuração aplica-se apenas às questões que têm várias partes, como as questões de múltipla escolha ou de associação. Para múltipla escolha, a ordem das respostas é misturada e para associação, como as respostas são sempre misturadas,  a ordem das questões também é misturada.';
...
$string['toomanyrandom'] = 'O número de questões aleatórias requerido é superior ao disponível nesta categoria!';
$string['top'] = 'Topo';
